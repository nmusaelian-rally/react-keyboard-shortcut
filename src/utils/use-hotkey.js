...
import { disabledEventPropagation } from './stop-bubble'
...
const useKeyboardShortcut = (shortcutKeys, callback, options) => {
  ...
  //keys is state, setKeys is dispatch fn
  ...
  const keydownListener = useCallback(
    ...
    assignedKey => keydownEvent => {
      ...
      //dispatch fn takes action object as arg, with action type and payload properties
